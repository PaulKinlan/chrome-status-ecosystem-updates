...
- 🐦 **Twitter / X:** [Harry Roberts - Speculation Rules rules!](https://twitter.com/csswizardry/status/1849449487078449244) — *by @csswizardry, 0 likes/RTs, 0 replies*
...
- **Brave Search:** 39 result(s) found across 8 planned queries — **10 verified relevant**
  ...
  - `"storage.googleapis.com/spec-previews/WICG/nav-speculation/pull/426/diff/prerendering.html" -site:storage.googleapis.com` *(Reverse Citation)* — *Inbound citations linking to Specification* (3 returned)
  - `"Speculation rules: form_submission field" API` — *Core feature API query* (6 returned)
